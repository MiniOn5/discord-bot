...
const products = {
    private: {
        ...
        features: [
            ...
            '✅ Актуальные паки пролёток, анимаций и одежды (общая стоимость — 50 000+ ₽)'
        ],
        price: '999 ₽',
    ...
    cinematic: {
        ...
        items: [
            ...
            {
                title: '**🎯 Поштучные пролетки и услуги**',
                lines: [
        ...
        orderInfo: `Оформление через тикет в ${supportChannelMention}`
    },
    nitro: {
        name: '⚡ DISCORD NITRO',
